        ...
        <div>
            ...
            >
                ...
                <div className="pt-2">
                    ...
                    <a href="https://github.com/leesadie/patterns-of-growth/notebooks" target="_blank" rel="noopener noreferrer" className="underline underline-offset-2 hover:opacity-60 decoration-1 transition duration-200">
                        visualization code
                    </a>
                    <span className="pr-1">
                        . Explore the 
